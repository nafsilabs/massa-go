...
type RespResult struct {
	...
	//	*RespResult_DeferredCallQuoteResult
	//	*RespResult_DeferredCallExistsResult
	//	*RespResult_DeferredCallRegisterResult
	//	*RespResult_DeferredCallCancelResult
...
func (x *RespResult) GetRes() isRespResult_Res {
	if x != nil {
		return x.Res
	}
	return nil
...
func (x *RespResult) GetAddNativeAmountResult() *AddNativeAmountResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_AddNativeAmountResult); ok {
...
func (x *RespResult) GetAddressFromPubKeyResult() *AddressFromPubKeyResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_AddressFromPubKeyResult); ok {
...
func (x *RespResult) GetAppendDsValueResult() *AppendDsValueResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_AppendDsValueResult); ok {
...
func (x *RespResult) GetBase58CheckToBytesResult() *Base58CheckToBytesResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_Base58CheckToBytesResult); ok {
...
func (x *RespResult) GetBytesToBase58CheckResult() *BytesToBase58CheckResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_BytesToBase58CheckResult); ok {
...
func (x *RespResult) GetCallerHasWriteAccessResult() *CallerHasWriteAccessResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_CallerHasWriteAccessResult); ok {
...
func (x *RespResult) GetCheckAddressResult() *CheckAddressResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_CheckAddressResult); ok {
...
func (x *RespResult) GetCheckNativeAmountResult() *CheckNativeAmountResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_CheckNativeAmountResult); ok {
...
func (x *RespResult) GetCheckPubKeyResult() *CheckPubKeyResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_CheckPubKeyResult); ok {
...
func (x *RespResult) GetCheckSigResult() *CheckSigResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_CheckSigResult); ok {
...
func (x *RespResult) GetCheckedAddNativeTimeResult() *CheckedAddNativeTimeResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_CheckedAddNativeTimeResult); ok {
...
func (x *RespResult) GetCheckedDivRemNativeTimeResult() *CheckedDivRemNativeTimeResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_CheckedDivRemNativeTimeResult); ok {
...
func (x *RespResult) GetCheckedScalarDivRemNativeTimeResult() *CheckedScalarDivRemNativeTimeResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_CheckedScalarDivRemNativeTimeResult); ok {
...
func (x *RespResult) GetCheckedScalarMulNativeTimeResult() *CheckedScalarMulNativeTimeResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_CheckedScalarMulNativeTimeResult); ok {
...
func (x *RespResult) GetCheckedSubNativeTimeResult() *CheckedSubNativeTimeResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_CheckedSubNativeTimeResult); ok {
...
func (x *RespResult) GetCompareAddressResult() *CompareAddressResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_CompareAddressResult); ok {
...
func (x *RespResult) GetCompareNativeAmountResult() *CompareNativeAmountResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_CompareNativeAmountResult); ok {
...
func (x *RespResult) GetCompareNativeTimeResult() *CompareNativeTimeResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_CompareNativeTimeResult); ok {
...
func (x *RespResult) GetComparePubKeyResult() *ComparePubKeyResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_ComparePubKeyResult); ok {
...
func (x *RespResult) GetCreateScResult() *CreateScResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_CreateScResult); ok {
...
func (x *RespResult) GetDeleteDsEntryResult() *DeleteDsEntryResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_DeleteDsEntryResult); ok {
...
func (x *RespResult) GetDivRemNativeAmountResult() *DivRemNativeAmountResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_DivRemNativeAmountResult); ok {
...
func (x *RespResult) GetDsEntryExistsResult() *DsEntryExistsResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_DsEntryExistsResult); ok {
...
func (x *RespResult) GetFunctionExistsResult() *FunctionExistsResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_FunctionExistsResult); ok {
...
func (x *RespResult) GetGenerateEventResult() *GenerateEventResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GenerateEventResult); ok {
...
func (x *RespResult) GetGetAddressCategoryResult() *GetAddressCategoryResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetAddressCategoryResult); ok {
...
func (x *RespResult) GetGetAddressVersionResult() *GetAddressVersionResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetAddressVersionResult); ok {
...
func (x *RespResult) GetGetBalanceResult() *GetBalanceResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetBalanceResult); ok {
...
func (x *RespResult) GetGetBytecodeResult() *GetBytecodeResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetBytecodeResult); ok {
...
func (x *RespResult) GetGetCallCoinsResult() *GetCallCoinsResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetCallCoinsResult); ok {
...
func (x *RespResult) GetGetCallStackResult() *GetCallStackResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetCallStackResult); ok {
...
func (x *RespResult) GetGetCurrentSlotResult() *GetCurrentSlotResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetCurrentSlotResult); ok {
...
func (x *RespResult) GetGetDsKeysResult() *GetDsKeysResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetDsKeysResult); ok {
...
func (x *RespResult) GetGetDsValueResult() *GetDsValueResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetDsValueResult); ok {
...
func (x *RespResult) GetGetNativeTimeResult() *GetNativeTimeResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetNativeTimeResult); ok {
...
func (x *RespResult) GetGetOpDataResult() *GetOpDataResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetOpDataResult); ok {
...
func (x *RespResult) GetGetOpKeysResult() *GetOpKeysResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetOpKeysResult); ok {
...
func (x *RespResult) GetGetOriginOperationIdResult() *GetOriginOperationIdResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetOriginOperationIdResult); ok {
...
func (x *RespResult) GetGetOwnedAddressesResult() *GetOwnedAddressesResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetOwnedAddressesResult); ok {
...
func (x *RespResult) GetGetPubKeyVersionResult() *GetPubKeyVersionResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetPubKeyVersionResult); ok {
...
func (x *RespResult) GetGetRemainingGasResult() *GetRemainingGasResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetRemainingGasResult); ok {
...
func (x *RespResult) GetGetSignatureVersionResult() *GetSignatureVersionResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_GetSignatureVersionResult); ok {
...
func (x *RespResult) GetHashBlake3Result() *HashBlake3Result {
	if x != nil {
		if x, ok := x.Res.(*RespResult_HashBlake3Result); ok {
...
func (x *RespResult) GetHashSha256Result() *HashSha256Result {
	if x != nil {
		if x, ok := x.Res.(*RespResult_HashSha256Result); ok {
...
func (x *RespResult) GetOpEntryExistsResult() *OpEntryExistsResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_OpEntryExistsResult); ok {
...
func (x *RespResult) GetKeccak256Result() *Keccak256Result {
	if x != nil {
		if x, ok := x.Res.(*RespResult_Keccak256Result); ok {
...
func (x *RespResult) GetLocalExecutionResponse() *LocalExecutionResponse {
	if x != nil {
		if x, ok := x.Res.(*RespResult_LocalExecutionResponse); ok {
...
func (x *RespResult) GetNativeAmountFromStringResult() *NativeAmountFromStringResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_NativeAmountFromStringResult); ok {
...
func (x *RespResult) GetNativeAmountToStringResult() *NativeAmountToStringResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_NativeAmountToStringResult); ok {
...
func (x *RespResult) GetScalarDivRemNativeAmountResult() *ScalarDivRemNativeAmountResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_ScalarDivRemNativeAmountResult); ok {
...
func (x *RespResult) GetScalarMulNativeAmountResult() *ScalarMulNativeAmountResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_ScalarMulNativeAmountResult); ok {
...
func (x *RespResult) GetSendAsyncMessageResult() *SendAsyncMessageResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_SendAsyncMessageResult); ok {
...
func (x *RespResult) GetSetBytecodeResult() *SetBytecodeResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_SetBytecodeResult); ok {
...
func (x *RespResult) GetSetDsValueResult() *SetDsValueResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_SetDsValueResult); ok {
...
func (x *RespResult) GetSubNativeAmountResult() *SubNativeAmountResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_SubNativeAmountResult); ok {
...
func (x *RespResult) GetTransferCoinsResult() *TransferCoinsResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_TransferCoinsResult); ok {
...
func (x *RespResult) GetUnsafeRandomResult() *UnsafeRandomResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_UnsafeRandomResult); ok {
...
func (x *RespResult) GetEvmVerifySigResult() *EvmVerifySigResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_EvmVerifySigResult); ok {
...
func (x *RespResult) GetVerifySigResult() *VerifySigResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_VerifySigResult); ok {
...
func (x *RespResult) GetEvmGetAddressFromPubkeyResult() *EvmGetAddressFromPubkeyResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_EvmGetAddressFromPubkeyResult); ok {
...
func (x *RespResult) GetEvmGetPubkeyFromSignatureResult() *EvmGetPubkeyFromSignatureResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_EvmGetPubkeyFromSignatureResult); ok {
...
func (x *RespResult) GetIsAddressEoaResult() *IsAddressEoaResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_IsAddressEoaResult); ok {
...
func (x *RespResult) GetChainIdResult() *ChainIdResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_ChainIdResult); ok {
...
func (x *RespResult) GetDeferredCallQuoteResult() *DeferredCallQuoteResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_DeferredCallQuoteResult); ok {
			return x.DeferredCallQuoteResult
		}
	}
	return nil
}

func (x *RespResult) GetDeferredCallExistsResult() *DeferredCallExistsResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_DeferredCallExistsResult); ok {
			return x.DeferredCallExistsResult
		}
	}
	return nil
}

func (x *RespResult) GetDeferredCallRegisterResult() *DeferredCallRegisterResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_DeferredCallRegisterResult); ok {
			return x.DeferredCallRegisterResult
		}
	}
	return nil
}

func (x *RespResult) GetDeferredCallCancelResult() *DeferredCallCancelResult {
	if x != nil {
		if x, ok := x.Res.(*RespResult_DeferredCallCancelResult); ok {
			return x.DeferredCallCancelResult
		}
	}
	return nil
}
...
type RespResult_DeferredCallQuoteResult struct {
	DeferredCallQuoteResult *DeferredCallQuoteResult `protobuf:"bytes,64,opt,name=deferred_call_quote_result,json=deferredCallQuoteResult,proto3,oneof"`
}

type RespResult_DeferredCallExistsResult struct {
	DeferredCallExistsResult *DeferredCallExistsResult `protobuf:"bytes,65,opt,name=deferred_call_exists_result,json=deferredCallExistsResult,proto3,oneof"`
}

type RespResult_DeferredCallRegisterResult struct {
	DeferredCallRegisterResult *DeferredCallRegisterResult `protobuf:"bytes,66,opt,name=deferred_call_register_result,json=deferredCallRegisterResult,proto3,oneof"`
}

type RespResult_DeferredCallCancelResult struct {
	DeferredCallCancelResult *DeferredCallCancelResult `protobuf:"bytes,67,opt,name=deferred_call_cancel_result,json=deferredCallCancelResult,proto3,oneof"`
}
...
func (*RespResult_DeferredCallQuoteResult) isRespResult_Res() {}

func (*RespResult_DeferredCallExistsResult) isRespResult_Res() {}

func (*RespResult_DeferredCallRegisterResult) isRespResult_Res() {}

func (*RespResult_DeferredCallCancelResult) isRespResult_Res() {}
...
func (x *AbiResponse) GetResp() isAbiResponse_Resp {
	if x != nil {
		return x.Resp
	}
	return nil
...
func (x *AbiResponse) GetRes() *RespResult {
	if x != nil {
		if x, ok := x.Resp.(*AbiResponse_Res); ok {
			return x.Res
		}
	}
	return nil
...
func (x *AbiResponse) GetError() *Error {
	if x != nil {
		if x, ok := x.Resp.(*AbiResponse_Error); ok {
			return x.Error
		}
	}
	return nil
...
type DeferredCallCancelRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// / call id
	CallId        *wrapperspb.StringValue `protobuf:"bytes,1,opt,name=call_id,json=callId,proto3" json:"call_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DeferredCallCancelRequest) Reset() {
	*x = DeferredCallCancelRequest{}
	mi := &file_massa_abi_v1_abi_proto_msgTypes[89]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeferredCallCancelRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeferredCallCancelRequest) ProtoMessage() {}

func (x *DeferredCallCancelRequest) ProtoReflect() protoreflect.Message {
	mi := &file_massa_abi_v1_abi_proto_msgTypes[89]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeferredCallCancelRequest.ProtoReflect.Descriptor instead.
func (*DeferredCallCancelRequest) Descriptor() ([]byte, []int) {
	return file_massa_abi_v1_abi_proto_rawDescGZIP(), []int{89}
}

func (x *DeferredCallCancelRequest) GetCallId() *wrapperspb.StringValue {
	if x != nil {
		return x.CallId
	}
	return nil
...
type DeferredCallCancelResult struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DeferredCallCancelResult) Reset() {
	*x = DeferredCallCancelResult{}
	mi := &file_massa_abi_v1_abi_proto_msgTypes[90]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeferredCallCancelResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeferredCallCancelResult) ProtoMessage() {}

func (x *DeferredCallCancelResult) ProtoReflect() protoreflect.Message {
	mi := &file_massa_abi_v1_abi_proto_msgTypes[90]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeferredCallCancelResult.ProtoReflect.Descriptor instead.
func (*DeferredCallCancelResult) Descriptor() ([]byte, []int) {
	return file_massa_abi_v1_abi_proto_rawDescGZIP(), []int{90}
}

// Deferred call quote
type DeferredCallQuoteRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// / target slot
...
func (x *DeferredCallQuoteRequest) Reset() {
	*x = DeferredCallQuoteRequest{}
	mi := &file_massa_abi_v1_abi_proto_msgTypes[91]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeferredCallQuoteRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeferredCallQuoteRequest) ProtoMessage() {}

func (x *DeferredCallQuoteRequest) ProtoReflect() protoreflect.Message {
	mi := &file_massa_abi_v1_abi_proto_msgTypes[91]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeferredCallQuoteRequest.ProtoReflect.Descriptor instead.
func (*DeferredCallQuoteRequest) Descriptor() ([]byte, []int) {
	return file_massa_abi_v1_abi_proto_rawDescGZIP(), []int{91}
}

func (x *DeferredCallQuoteRequest) GetTargetSlot() *v1.Slot {
	if x != nil {
		return x.TargetSlot
	}
	return nil
...
func (x *DeferredCallQuoteRequest) GetMaxGas() uint64 {
	if x != nil {
		return x.MaxGas
	}
	return 0
...
func (x *DeferredCallQuoteRequest) GetParamsSize() uint64 {
	if x != nil {
		return x.ParamsSize
	}
	return 0
...
type DeferredCallQuoteResult struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// / available
...
func (x *DeferredCallQuoteResult) Reset() {
	*x = DeferredCallQuoteResult{}
	mi := &file_massa_abi_v1_abi_proto_msgTypes[92]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeferredCallQuoteResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeferredCallQuoteResult) ProtoMessage() {}

func (x *DeferredCallQuoteResult) ProtoReflect() protoreflect.Message {
	mi := &file_massa_abi_v1_abi_proto_msgTypes[92]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeferredCallQuoteResult.ProtoReflect.Descriptor instead.
func (*DeferredCallQuoteResult) Descriptor() ([]byte, []int) {
	return file_massa_abi_v1_abi_proto_rawDescGZIP(), []int{92}
}

func (x *DeferredCallQuoteResult) GetAvailable() bool {
	if x != nil {
		return x.Available
	}
	return false
...
func (x *DeferredCallQuoteResult) GetCost() uint64 {
	if x != nil {
		return x.Cost
	}
	return 0
...
type DeferredCallExistsRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// / deferred call id
	CallId        *wrapperspb.StringValue `protobuf:"bytes,1,opt,name=call_id,json=callId,proto3" json:"call_id,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *DeferredCallExistsRequest) Reset() {
	*x = DeferredCallExistsRequest{}
	mi := &file_massa_abi_v1_abi_proto_msgTypes[93]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeferredCallExistsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeferredCallExistsRequest) ProtoMessage() {}

func (x *DeferredCallExistsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_massa_abi_v1_abi_proto_msgTypes[93]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeferredCallExistsRequest.ProtoReflect.Descriptor instead.
func (*DeferredCallExistsRequest) Descriptor() ([]byte, []int) {
	return file_massa_abi_v1_abi_proto_rawDescGZIP(), []int{93}
}

func (x *DeferredCallExistsRequest) GetCallId() *wrapperspb.StringValue {
	if x != nil {
		return x.CallId
	}
	return nil
...
type DeferredCallExistsResult struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// / call exists
	CallExists    bool `protobuf:"varint,1,opt,name=call_exists,json=callExists,proto3" json:"call_exists,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DeferredCallExistsResult) Reset() {
	*x = DeferredCallExistsResult{}
	mi := &file_massa_abi_v1_abi_proto_msgTypes[94]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeferredCallExistsResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeferredCallExistsResult) ProtoMessage() {}

func (x *DeferredCallExistsResult) ProtoReflect() protoreflect.Message {
	mi := &file_massa_abi_v1_abi_proto_msgTypes[94]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeferredCallExistsResult.ProtoReflect.Descriptor instead.
func (*DeferredCallExistsResult) Descriptor() ([]byte, []int) {
	return file_massa_abi_v1_abi_proto_rawDescGZIP(), []int{94}
}

func (x *DeferredCallExistsResult) GetCallExists() bool {
	if x != nil {
		return x.CallExists
	}
	return false
...
type DeferredCallRegisterRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// / target address
	TargetAddress string `protobuf:"bytes,1,opt,name=target_address,json=targetAddress,proto3" json:"target_address,omitempty"`
	// / target function
	...
	// / start slot
	TargetSlot *v1.Slot `protobuf:"bytes,3,opt,name=target_slot,json=targetSlot,proto3" json:"target_slot,omitempty"`
	// / gas requested
...
func (x *DeferredCallRegisterRequest) Reset() {
	*x = DeferredCallRegisterRequest{}
	mi := &file_massa_abi_v1_abi_proto_msgTypes[95]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeferredCallRegisterRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeferredCallRegisterRequest) ProtoMessage() {}

func (x *DeferredCallRegisterRequest) ProtoReflect() protoreflect.Message {
	mi := &file_massa_abi_v1_abi_proto_msgTypes[95]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeferredCallRegisterRequest.ProtoReflect.Descriptor instead.
func (*DeferredCallRegisterRequest) Descriptor() ([]byte, []int) {
	return file_massa_abi_v1_abi_proto_rawDescGZIP(), []int{95}
}

func (x *DeferredCallRegisterRequest) GetTargetAddress() string {
	if x != nil {
		return x.TargetAddress
	}
	return ""
...
func (x *DeferredCallRegisterRequest) GetTargetFunction() string {
	if x != nil {
...
func (x *DeferredCallRegisterRequest) GetTargetSlot() *v1.Slot {
	if x != nil {
		return x.TargetSlot
	}
	return nil
...
func (x *DeferredCallRegisterRequest) GetMaxGas() uint64 {
	if x != nil {
		return x.MaxGas
	}
	return 0
...
func (x *DeferredCallRegisterRequest) GetParams() []byte {
	if x != nil {
		return x.Params
	}
	return nil
...
func (x *DeferredCallRegisterRequest) GetCoins() uint64 {
	if x != nil {
		return x.Coins
	}
	return 0
...
type DeferredCallRegisterResult struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// / deferred call id
	CallId        *wrapperspb.StringValue `protobuf:"bytes,1,opt,name=call_id,json=callId,proto3" json:"call_id,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *DeferredCallRegisterResult) Reset() {
	*x = DeferredCallRegisterResult{}
	mi := &file_massa_abi_v1_abi_proto_msgTypes[96]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeferredCallRegisterResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeferredCallRegisterResult) ProtoMessage() {}

func (x *DeferredCallRegisterResult) ProtoReflect() protoreflect.Message {
	mi := &file_massa_abi_v1_abi_proto_msgTypes[96]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeferredCallRegisterResult.ProtoReflect.Descriptor instead.
func (*DeferredCallRegisterResult) Descriptor() ([]byte, []int) {
	return file_massa_abi_v1_abi_proto_rawDescGZIP(), []int{96}
}

func (x *DeferredCallRegisterResult) GetCallId() *wrapperspb.StringValue {
	if x != nil {
		return x.CallId
	}
	return nil
...
func (x *GetSignatureVersionRequest) Reset() {
	*x = GetSignatureVersionRequest{}
	mi := &file_massa_abi_v1_abi_proto_msgTypes[132]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSignatureVersionRequest) Descriptor() ([]byte, []int) {
	return file_massa_abi_v1_abi_proto_rawDescGZIP(), []int{132}
}
...
func (x *GetSignatureVersionResult) Reset() {
	*x = GetSignatureVersionResult{}
	mi := &file_massa_abi_v1_abi_proto_msgTypes[133]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSignatureVersionResult) Descriptor() ([]byte, []int) {
	return file_massa_abi_v1_abi_proto_rawDescGZIP(), []int{133}
}
...
func (x *BytesToBase58CheckRequest) Reset() {
	*x = BytesToBase58CheckRequest{}
	mi := &file_massa_abi_v1_abi_proto_msgTypes[134]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BytesToBase58CheckRequest) Descriptor() ([]byte, []int) {
	return file_massa_abi_v1_abi_proto_rawDescGZIP(), []int{134}
}
...
func (x *BytesToBase58CheckResult) Reset() {
	*x = BytesToBase58CheckResult{}
	mi := &file_massa_abi_v1_abi_proto_msgTypes[135]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BytesToBase58CheckResult) Descriptor() ([]byte, []int) {
	return file_massa_abi_v1_abi_proto_rawDescGZIP(), []int{135}
}
...
func (x *Base58CheckToBytesRequest) Reset() {
	*x = Base58CheckToBytesRequest{}
	mi := &file_massa_abi_v1_abi_proto_msgTypes[136]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Base58CheckToBytesRequest) Descriptor() ([]byte, []int) {
	return file_massa_abi_v1_abi_proto_rawDescGZIP(), []int{136}
}
...
func (x *Base58CheckToBytesResult) Reset() {
	*x = Base58CheckToBytesResult{}
	mi := &file_massa_abi_v1_abi_proto_msgTypes[137]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Base58CheckToBytesResult) Descriptor() ([]byte, []int) {
	return file_massa_abi_v1_abi_proto_rawDescGZIP(), []int{137}
}
...
func (x *ChainIdRequest) Reset() {
	*x = ChainIdRequest{}
	mi := &file_massa_abi_v1_abi_proto_msgTypes[138]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChainIdRequest) Descriptor() ([]byte, []int) {
	return file_massa_abi_v1_abi_proto_rawDescGZIP(), []int{138}
}
...
func (x *ChainIdResult) Reset() {
	*x = ChainIdResult{}
	mi := &file_massa_abi_v1_abi_proto_msgTypes[139]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChainIdResult) Descriptor() ([]byte, []int) {
	return file_massa_abi_v1_abi_proto_rawDescGZIP(), []int{139}
}
...
const file_massa_abi_v1_abi_proto_rawDesc = "" +
	"\n" +
	"\x16massa/abi/v1/abi.proto\x12\fmassa.abi.v1\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1cmassa/model/v1/address.proto\x1a\x1bmassa/model/v1/amount.proto\x1a\x1cmassa/model/v1/commons.proto\x1a\x19massa/model/v1/slot.proto\x1a\x19massa/model/v1/time.proto\"!\n" +
	"\x05Error\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"-\n" +
	"\x0fCreateScRequest\x12\x1a\n" +
	"\bbytecode\x18\x01 \x01(\fR\bbytecode\"/\n" +
	"\x0eCreateScResult\x12\x1d\n" +
	"\n" +
	"sc_address\x18\x01 \x01(\tR\tscAddress\"\xcb\x01\n" +
	"\vCallRequest\x12*\n" +
	"\x11target_sc_address\x18\x01 \x01(\tR\x0ftargetScAddress\x120\n" +
	"\x14target_function_name\x18\x02 \x01(\tR\x12targetFunctionName\x12!\n" +
	"\ffunction_arg\x18\x03 \x01(\fR\vfunctionArg\x12;\n" +
	"\n" +
	"call_coins\x18\x04 \x01(\v2\x1c.massa.model.v1.NativeAmountR\tcallCoins\"\"\n" +
	"\fCallResponse\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\"\x88\x01\n" +
	"\x15LocalExecutionRequest\x12\x1a\n" +
	"\bbytecode\x18\x01 \x01(\fR\bbytecode\x120\n" +
	"\x14target_function_name\x18\x02 \x01(\tR\x12targetFunctionName\x12!\n" +
	"\ffunction_arg\x18\x03 \x01(\fR\vfunctionArg\",\n" +
	"\x16LocalExecutionResponse\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\",\n" +
	"\x14GenerateEventRequest\x12\x14\n" +
	"\x05event\x18\x01 \x01(\fR\x05event\"\x15\n" +
	"\x13GenerateEventResult\"\xe6\x01\n" +
	"\x14TransferCoinsRequest\x12%\n" +
	"\x0etarget_address\x18\x01 \x01(\tR\rtargetAddress\x12J\n" +
	"\x12amount_to_transfer\x18\x02 \x01(\v2\x1c.massa.model.v1.NativeAmountR\x10amountToTransfer\x12H\n" +
	"\x0esender_address\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueH\x00R\rsenderAddress\x88\x01\x01B\x11\n" +
	"\x0f_sender_address\"\x15\n" +
	"\x13TransferCoinsResult\"h\n" +
	"\x15FunctionExistsRequest\x12*\n" +
	"\x11target_sc_address\x18\x01 \x01(\tR\x0ftargetScAddress\x12#\n" +
	"\rfunction_name\x18\x02 \x01(\tR\ffunctionName\".\n" +
	"\x14FunctionExistsResult\x12\x16\n" +
	"\x06exists\x18\x01 \x01(\bR\x06exists\"\xf22\n" +
	"\n" +
	"RespResult\x12^\n" +
	"\x18add_native_amount_result\x18\x01 \x01(\v2#.massa.abi.v1.AddNativeAmountResultH\x00R\x15addNativeAmountResult\x12e\n" +
	"\x1baddress_from_pub_key_result\x18\x02 \x01(\v2%.massa.abi.v1.AddressFromPubKeyResultH\x00R\x17addressFromPubKeyResult\x12X\n" +
	"\x16append_ds_value_result\x18\x03 \x01(\v2!.massa.abi.v1.AppendDsValueResultH\x00R\x13appendDsValueResult\x12h\n" +
	"\x1cbase58_check_to_bytes_result\x18\x04 \x01(\v2&.massa.abi.v1.Base58CheckToBytesResultH\x00R\x18base58CheckToBytesResult\x12h\n" +
	"\x1cbytes_to_base58_check_result\x18\x05 \x01(\v2&.massa.abi.v1.BytesToBase58CheckResultH\x00R\x18bytesToBase58CheckResult\x12n\n" +
	"\x1ecaller_has_write_access_result\x18\x06 \x01(\v2(.massa.abi.v1.CallerHasWriteAccessResultH\x00R\x1acallerHasWriteAccessResult\x12T\n" +
	"\x14check_address_result\x18\a \x01(\v2 .massa.abi.v1.CheckAddressResultH\x00R\x12checkAddressResult\x12d\n" +
	"\x1acheck_native_amount_result\x18\b \x01(\v2%.massa.abi.v1.CheckNativeAmountResultH\x00R\x17checkNativeAmountResult\x12R\n" +
	"\x14check_pub_key_result\x18\t \x01(\v2\x1f.massa.abi.v1.CheckPubKeyResultH\x00R\x11checkPubKeyResult\x12H\n" +
	"\x10check_sig_result\x18\n" +
	" \x01(\v2\x1c.massa.abi.v1.CheckSigResultH\x00R\x0echeckSigResult\x12n\n" +
	"\x1echecked_add_native_time_result\x18\v \x01(\v2(.massa.abi.v1.CheckedAddNativeTimeResultH\x00R\x1acheckedAddNativeTimeResult\x12x\n" +
	"\"checked_div_rem_native_time_result\x18\f \x01(\v2+.massa.abi.v1.CheckedDivRemNativeTimeResultH\x00R\x1dcheckedDivRemNativeTimeResult\x12\x8b\x01\n" +
	")checked_scalar_div_rem_native_time_result\x18\r \x01(\v21.massa.abi.v1.CheckedScalarDivRemNativeTimeResultH\x00R#checkedScalarDivRemNativeTimeResult\x12\x81\x01\n" +
	"%checked_scalar_mul_native_time_result\x18\x0e \x01(\v2..massa.abi.v1.CheckedScalarMulNativeTimeResultH\x00R checkedScalarMulNativeTimeResult\x12n\n" +
	"\x1echecked_sub_native_time_result\x18\x0f \x01(\v2(.massa.abi.v1.CheckedSubNativeTimeResultH\x00R\x1acheckedSubNativeTimeResult\x12Z\n" +
	"\x16compare_address_result\x18\x10 \x01(\v2\".massa.abi.v1.CompareAddressResultH\x00R\x14compareAddressResult\x12j\n" +
	"\x1ccompare_native_amount_result\x18\x11 \x01(\v2'.massa.abi.v1.CompareNativeAmountResultH\x00R\x19compareNativeAmountResult\x12d\n" +
	"\x1acompare_native_time_result\x18\x12 \x01(\v2%.massa.abi.v1.CompareNativeTimeResultH\x00R\x17compareNativeTimeResult\x12X\n" +
	"\x16compare_pub_key_result\x18\x13 \x01(\v2!.massa.abi.v1.ComparePubKeyResultH\x00R\x13comparePubKeyResult\x12H\n" +
	"\x10create_sc_result\x18\x14 \x01(\v2\x1c.massa.abi.v1.CreateScResultH\x00R\x0ecreateScResult\x12X\n" +
	"\x16delete_ds_entry_result\x18\x15 \x01(\v2!.massa.abi.v1.DeleteDsEntryResultH\x00R\x13deleteDsEntryResult\x12h\n" +
	"\x1cdiv_rem_native_amount_result\x18\x16 \x01(\v2&.massa.abi.v1.DivRemNativeAmountResultH\x00R\x18divRemNativeAmountResult\x12X\n" +
	"\x16ds_entry_exists_result\x18\x17 \x01(\v2!.massa.abi.v1.DsEntryExistsResultH\x00R\x13dsEntryExistsResult\x12Z\n" +
	"\x16function_exists_result\x18\x18 \x01(\v2\".massa.abi.v1.FunctionExistsResultH\x00R\x14functionExistsResult\x12W\n" +
	"\x15generate_event_result\x18\x19 \x01(\v2!.massa.abi.v1.GenerateEventResultH\x00R\x13generateEventResult\x12g\n" +
	"\x1bget_address_category_result\x18\x1a \x01(\v2&.massa.abi.v1.GetAddressCategoryResultH\x00R\x18getAddressCategoryResult\x12d\n" +
	"\x1aget_address_version_result\x18\x1b \x01(\v2%.massa.abi.v1.GetAddressVersionResultH\x00R\x17getAddressVersionResult\x12N\n" +
	"\x12get_balance_result\x18\x1c \x01(\v2\x1e.massa.abi.v1.GetBalanceResultH\x00R\x10getBalanceResult\x12Q\n" +
	"\x13get_bytecode_result\x18\x1d \x01(\v2\x1f.massa.abi.v1.GetBytecodeResultH\x00R\x11getBytecodeResult\x12U\n" +
	"\x15get_call_coins_result\x18\x1e \x01(\v2 .massa.abi.v1.GetCallCoinsResultH\x00R\x12getCallCoinsResult\x12U\n" +
	"\x15get_call_stack_result\x18\x1f \x01(\v2 .massa.abi.v1.GetCallStackResultH\x00R\x12getCallStackResult\x12[\n" +
	"\x17get_current_slot_result\x18  \x01(\v2\".massa.abi.v1.GetCurrentSlotResultH\x00R\x14getCurrentSlotResult\x12L\n" +
	"\x12get_ds_keys_result\x18! \x01(\v2\x1d.massa.abi.v1.GetDsKeysResultH\x00R\x0fgetDsKeysResult\x12O\n" +
	"\x13get_ds_value_result\x18\" \x01(\v2\x1e.massa.abi.v1.GetDsValueResultH\x00R\x10getDsValueResult\x12X\n" +
	"\x16get_native_time_result\x18# \x01(\v2!.massa.abi.v1.GetNativeTimeResultH\x00R\x13getNativeTimeResult\x12L\n" +
	"\x12get_op_data_result\x18$ \x01(\v2\x1d.massa.abi.v1.GetOpDataResultH\x00R\x0fgetOpDataResult\x12L\n" +
	"\x12get_op_keys_result\x18% \x01(\v2\x1d.massa.abi.v1.GetOpKeysResultH\x00R\x0fgetOpKeysResult\x12n\n" +
	"\x1eget_origin_operation_id_result\x18& \x01(\v2(.massa.abi.v1.GetOriginOperationIdResultH\x00R\x1agetOriginOperationIdResult\x12d\n" +
	"\x1aget_owned_addresses_result\x18' \x01(\v2%.massa.abi.v1.GetOwnedAddressesResultH\x00R\x17getOwnedAddressesResult\x12b\n" +
	"\x1aget_pub_key_version_result\x18( \x01(\v2$.massa.abi.v1.GetPubKeyVersionResultH\x00R\x16getPubKeyVersionResult\x12^\n" +
	"\x18get_remaining_gas_result\x18) \x01(\v2#.massa.abi.v1.GetRemainingGasResultH\x00R\x15getRemainingGasResult\x12j\n" +
	"\x1cget_signature_version_result\x18* \x01(\v2'.massa.abi.v1.GetSignatureVersionResultH\x00R\x19getSignatureVersionResult\x12N\n" +
	"\x12hash_blake3_result\x18+ \x01(\v2\x1e.massa.abi.v1.HashBlake3ResultH\x00R\x10hashBlake3Result\x12N\n" +
	"\x12hash_sha256_result\x18, \x01(\v2\x1e.massa.abi.v1.HashSha256ResultH\x00R\x10hashSha256Result\x12X\n" +
	"\x16op_entry_exists_result\x18- \x01(\v2!.massa.abi.v1.OpEntryExistsResultH\x00R\x13opEntryExistsResult\x12J\n" +
	"\x10keccak256_result\x18. \x01(\v2\x1d.massa.abi.v1.Keccak256ResultH\x00R\x0fkeccak256Result\x12`\n" +
	"\x18local_execution_response\x18/ \x01(\v2$.massa.abi.v1.LocalExecutionResponseH\x00R\x16localExecutionResponse\x12t\n" +
	" native_amount_from_string_result\x180 \x01(\v2*.massa.abi.v1.NativeAmountFromStringResultH\x00R\x1cnativeAmountFromStringResult\x12n\n" +
	"\x1enative_amount_to_string_result\x181 \x01(\v2(.massa.abi.v1.NativeAmountToStringResultH\x00R\x1anativeAmountToStringResult\x12{\n" +
	"#scalar_div_rem_native_amount_result\x182 \x01(\v2,.massa.abi.v1.ScalarDivRemNativeAmountResultH\x00R\x1escalarDivRemNativeAmountResult\x12q\n" +
	"\x1fscalar_mul_native_amount_result\x183 \x01(\v2).massa.abi.v1.ScalarMulNativeAmountResultH\x00R\x1bscalarMulNativeAmountResult\x12a\n" +
	"\x19send_async_message_result\x184 \x01(\v2$.massa.abi.v1.SendAsyncMessageResultH\x00R\x16sendAsyncMessageResult\x12Q\n" +
	"\x13set_bytecode_result\x185 \x01(\v2\x1f.massa.abi.v1.SetBytecodeResultH\x00R\x11setBytecodeResult\x12O\n" +
	"\x13set_ds_value_result\x186 \x01(\v2\x1e.massa.abi.v1.SetDsValueResultH\x00R\x10setDsValueResult\x12^\n" +
	"\x18sub_native_amount_result\x187 \x01(\v2#.massa.abi.v1.SubNativeAmountResultH\x00R\x15subNativeAmountResult\x12W\n" +
	"\x15transfer_coins_result\x188 \x01(\v2!.massa.abi.v1.TransferCoinsResultH\x00R\x13transferCoinsResult\x12T\n" +
	"\x14unsafe_random_result\x189 \x01(\v2 .massa.abi.v1.UnsafeRandomResultH\x00R\x12unsafeRandomResult\x12U\n" +
	"\x15evm_verify_sig_result\x18: \x01(\v2 .massa.abi.v1.EvmVerifySigResultH\x00R\x12evmVerifySigResult\x12K\n" +
	"\x11verify_sig_result\x18; \x01(\v2\x1d.massa.abi.v1.VerifySigResultH\x00R\x0fverifySigResult\x12x\n" +
	"\"evm_get_address_from_pubkey_result\x18< \x01(\v2+.massa.abi.v1.EvmGetAddressFromPubkeyResultH\x00R\x1devmGetAddressFromPubkeyResult\x12~\n" +
	"$evm_get_pubkey_from_signature_result\x18= \x01(\v2-.massa.abi.v1.EvmGetPubkeyFromSignatureResultH\x00R\x1fevmGetPubkeyFromSignatureResult\x12U\n" +
	"\x15is_address_eoa_result\x18> \x01(\v2 .massa.abi.v1.IsAddressEoaResultH\x00R\x12isAddressEoaResult\x12E\n" +
	"\x0fchain_id_result\x18? \x01(\v2\x1b.massa.abi.v1.ChainIdResultH\x00R\rchainIdResult\x12d\n" +
	"\x1adeferred_call_quote_result\x18@ \x01(\v2%.massa.abi.v1.DeferredCallQuoteResultH\x00R\x17deferredCallQuoteResult\x12g\n" +
	"\x1bdeferred_call_exists_result\x18A \x01(\v2&.massa.abi.v1.DeferredCallExistsResultH\x00R\x18deferredCallExistsResult\x12m\n" +
	"\x1ddeferred_call_register_result\x18B \x01(\v2(.massa.abi.v1.DeferredCallRegisterResultH\x00R\x1adeferredCallRegisterResult\x12g\n" +
	"\x1bdeferred_call_cancel_result\x18C \x01(\v2&.massa.abi.v1.DeferredCallCancelResultH\x00R\x18deferredCallCancelResultB\x05\n" +
	"\x03res\"p\n" +
	"\vAbiResponse\x12,\n" +
	"\x03res\x18\x01 \x01(\v2\x18.massa.abi.v1.RespResultH\x00R\x03res\x12+\n" +
	"\x05error\x18\x02 \x01(\v2\x13.massa.abi.v1.ErrorH\x00R\x05errorB\x06\n" +
	"\x04resp\"Z\n" +
	"\x1bNativeAmountToStringRequest\x12;\n" +
	"\n" +
	"to_convert\x18\x01 \x01(\v2\x1c.massa.model.v1.NativeAmountR\ttoConvert\"G\n" +
	"\x1aNativeAmountToStringResult\x12)\n" +
	"\x10converted_amount\x18\x01 \x01(\tR\x0fconvertedAmount\">\n" +
	"\x1dNativeAmountFromStringRequest\x12\x1d\n" +
	"\n" +
	"to_convert\x18\x01 \x01(\tR\ttoConvert\"g\n" +
	"\x1cNativeAmountFromStringResult\x12G\n" +
	"\x10converted_amount\x18\x01 \x01(\v2\x1c.massa.model.v1.NativeAmountR\x0fconvertedAmount\"0\n" +
	"\x13CheckAddressRequest\x12\x19\n" +
	"\bto_check\x18\x01 \x01(\tR\atoCheck\"/\n" +
	"\x12CheckAddressResult\x12\x19\n" +
	"\bis_valid\x18\x01 \x01(\bR\aisValid\"/\n" +
	"\x12CheckPubKeyRequest\x12\x19\n" +
	"\bto_check\x18\x01 \x01(\tR\atoCheck\".\n" +
	"\x11CheckPubKeyResult\x12\x19\n" +
	"\bis_valid\x18\x01 \x01(\bR\aisValid\",\n" +
	"\x0fCheckSigRequest\x12\x19\n" +
	"\bto_check\x18\x01 \x01(\tR\atoCheck\"+\n" +
	"\x0eCheckSigResult\x12\x19\n" +
	"\bis_valid\x18\x01 \x01(\bR\aisValid\"S\n" +
	"\x18CheckNativeAmountRequest\x127\n" +
	"\bto_check\x18\x01 \x01(\v2\x1c.massa.model.v1.NativeAmountR\atoCheck\"4\n" +
	"\x17CheckNativeAmountResult\x12\x19\n" +
	"\bis_valid\x18\x01 \x01(\bR\aisValid\"\x88\x01\n" +
	"\x16AddNativeAmountRequest\x126\n" +
	"\aamount1\x18\x01 \x01(\v2\x1c.massa.model.v1.NativeAmountR\aamount1\x126\n" +
	"\aamount2\x18\x02 \x01(\v2\x1c.massa.model.v1.NativeAmountR\aamount2\"G\n" +
	"\x15AddNativeAmountResult\x12.\n" +
	"\x03sum\x18\x01 \x01(\v2\x1c.massa.model.v1.NativeAmountR\x03sum\"~\n" +
	"\x16SubNativeAmountRequest\x120\n" +
	"\x04left\x18\x01 \x01(\v2\x1c.massa.model.v1.NativeAmountR\x04left\x122\n" +
	"\x05right\x18\x02 \x01(\v2\x1c.massa.model.v1.NativeAmountR\x05right\"U\n" +
	"\x15SubNativeAmountResult\x12<\n" +
	"\n" +
	"difference\x18\x01 \x01(\v2\x1c.massa.model.v1.NativeAmountR\n" +
	"difference\"v\n" +
	"\x1cScalarMulNativeAmountRequest\x124\n" +
	"\x06amount\x18\x01 \x01(\v2\x1c.massa.model.v1.NativeAmountR\x06amount\x12 \n" +
	"\vcoefficient\x18\x02 \x01(\x04R\vcoefficient\"U\n" +
	"\x1bScalarMulNativeAmountResult\x126\n" +
	"\aproduct\x18\x01 \x01(\v2\x1c.massa.model.v1.NativeAmountR\aproduct\"u\n" +
	"\x1fScalarDivRemNativeAmountRequest\x128\n" +
	"\bdividend\x18\x01 \x01(\v2\x1c.massa.model.v1.NativeAmountR\bdividend\x12\x18\n" +
	"\adivisor\x18\x02 \x01(\x04R\adivisor\"\x96\x01\n" +
	"\x1eScalarDivRemNativeAmountResult\x128\n" +
	"\bquotient\x18\x01 \x01(\v2\x1c.massa.model.v1.NativeAmountR\bquotient\x12:\n" +
	"\tremainder\x18\x02 \x01(\v2\x1c.massa.model.v1.NativeAmountR\tremainder\"\x8d\x01\n" +
	"\x19DivRemNativeAmountRequest\x128\n" +
	"\bdividend\x18\x01 \x01(\v2\x1c.massa.model.v1.NativeAmountR\bdividend\x126\n" +
	"\adivisor\x18\x02 \x01(\v2\x1c.massa.model.v1.NativeAmountR\adivisor\"r\n" +
	"\x18DivRemNativeAmountResult\x12\x1a\n" +
	"\bquotient\x18\x01 \x01(\x04R\bquotient\x12:\n" +
	"\tremainder\x18\x02 \x01(\v2\x1c.massa.model.v1.NativeAmountR\tremainder\"\x7f\n" +
	"\x1bCheckedAddNativeTimeRequest\x12.\n" +
	"\x04left\x18\x01 \x01(\v2\x1a.massa.model.v1.NativeTimeR\x04left\x120\n" +
	"\x05right\x18\x02 \x01(\v2\x1a.massa.model.v1.NativeTimeR\x05right\"J\n" +
	"\x1aCheckedAddNativeTimeResult\x12,\n" +
	"\x03sum\x18\x01 \x01(\v2\x1a.massa.model.v1.NativeTimeR\x03sum\"\x7f\n" +
	"\x1bCheckedSubNativeTimeRequest\x12.\n" +
	"\x04left\x18\x01 \x01(\v2\x1a.massa.model.v1.NativeTimeR\x04left\x120\n" +
	"\x05right\x18\x02 \x01(\v2\x1a.massa.model.v1.NativeTimeR\x05right\"X\n" +
	"\x1aCheckedSubNativeTimeResult\x12:\n" +
	"\n" +
	"difference\x18\x01 \x01(\v2\x1a.massa.model.v1.NativeTimeR\n" +
	"difference\"u\n" +
	"!CheckedScalarMulNativeTimeRequest\x12.\n" +
	"\x04time\x18\x01 \x01(\v2\x1a.massa.model.v1.NativeTimeR\x04time\x12 \n" +
	"\vcoefficient\x18\x02 \x01(\x04R\vcoefficient\"X\n" +
	" CheckedScalarMulNativeTimeResult\x124\n" +
	"\aproduct\x18\x01 \x01(\v2\x1a.massa.model.v1.NativeTimeR\aproduct\"x\n" +
	"$CheckedScalarDivRemNativeTimeRequest\x126\n" +
	"\bdividend\x18\x01 \x01(\v2\x1a.massa.model.v1.NativeTimeR\bdividend\x12\x18\n" +
	"\adivisor\x18\x02 \x01(\x04R\adivisor\"\x97\x01\n" +
	"#CheckedScalarDivRemNativeTimeResult\x126\n" +
	"\bquotient\x18\x01 \x01(\v2\x1a.massa.model.v1.NativeTimeR\bquotient\x128\n" +
	"\tremainder\x18\x02 \x01(\v2\x1a.massa.model.v1.NativeTimeR\tremainder\"\x8e\x01\n" +
	"\x1eCheckedDivRemNativeTimeRequest\x126\n" +
	"\bdividend\x18\x01 \x01(\v2\x1a.massa.model.v1.NativeTimeR\bdividend\x124\n" +
	"\adivisor\x18\x02 \x01(\v2\x1a.massa.model.v1.NativeTimeR\adivisor\"u\n" +
	"\x1dCheckedDivRemNativeTimeResult\x12\x1a\n" +
	"\bquotient\x18\x01 \x01(\x04R\bquotient\x128\n" +
	"\tremainder\x18\x02 \x01(\v2\x1a.massa.model.v1.NativeTimeR\tremainder\"|\n" +
	"\x18CompareNativeTimeRequest\x12.\n" +
	"\x04left\x18\x01 \x01(\v2\x1a.massa.model.v1.NativeTimeR\x04left\x120\n" +
	"\x05right\x18\x02 \x01(\v2\x1a.massa.model.v1.NativeTimeR\x05right\"S\n" +
	"\x17CompareNativeTimeResult\x128\n" +
	"\x06result\x18\x01 \x01(\x0e2 .massa.model.v1.ComparisonResultR\x06result\"A\n" +
	"\x15CompareAddressRequest\x12\x12\n" +
	"\x04left\x18\x01 \x01(\tR\x04left\x12\x14\n" +
	"\x05right\x18\x02 \x01(\tR\x05right\"P\n" +
	"\x14CompareAddressResult\x128\n" +
	"\x06result\x18\x01 \x01(\x0e2 .massa.model.v1.ComparisonResultR\x06result\"@\n" +
	"\x14ComparePubKeyRequest\x12\x12\n" +
	"\x04left\x18\x01 \x01(\tR\x04left\x12\x14\n" +
	"\x05right\x18\x02 \x01(\tR\x05right\"O\n" +
	"\x13ComparePubKeyResult\x128\n" +
	"\x06result\x18\x01 \x01(\x0e2 .massa.model.v1.ComparisonResultR\x06result\"W\n" +
	"\x10VerifySigRequest\x12\x10\n" +
	"\x03sig\x18\x01 \x01(\tR\x03sig\x12\x18\n" +
	"\amessage\x18\x02 \x01(\fR\amessage\x12\x17\n" +
	"\apub_key\x18\x03 \x01(\tR\x06pubKey\"2\n" +
	"\x0fVerifySigResult\x12\x1f\n" +
	"\vis_verified\x18\x01 \x01(\bR\n" +
	"isVerified\"\x82\x01\n" +
	"\x1aCompareNativeAmountRequest\x120\n" +
	"\x04left\x18\x01 \x01(\v2\x1c.massa.model.v1.NativeAmountR\x04left\x122\n" +
	"\x05right\x18\x02 \x01(\v2\x1c.massa.model.v1.NativeAmountR\x05right\"U\n" +
	"\x19CompareNativeAmountResult\x128\n" +
	"\x06result\x18\x01 \x01(\x0e2 .massa.model.v1.ComparisonResultR\x06result\"&\n" +
	"\x10Keccak256Request\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\"%\n" +
	"\x0fKeccak256Result\x12\x12\n" +
	"\x04hash\x18\x01 \x01(\fR\x04hash\"Z\n" +
	"\x13EvmVerifySigRequest\x12\x10\n" +
	"\x03sig\x18\x01 \x01(\fR\x03sig\x12\x18\n" +
	"\amessage\x18\x02 \x01(\fR\amessage\x12\x17\n" +
	"\apub_key\x18\x03 \x01(\fR\x06pubKey\"5\n" +
	"\x12EvmVerifySigResult\x12\x1f\n" +
	"\vis_verified\x18\x01 \x01(\bR\n" +
	"isVerified\"9\n" +
	"\x1eEvmGetAddressFromPubkeyRequest\x12\x17\n" +
	"\apub_key\x18\x01 \x01(\fR\x06pubKey\"9\n" +
	"\x1dEvmGetAddressFromPubkeyResult\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\fR\aaddress\"H\n" +
	" EvmGetPubkeyFromSignatureRequest\x12\x12\n" +
	"\x04hash\x18\x01 \x01(\fR\x04hash\x12\x10\n" +
	"\x03sig\x18\x02 \x01(\fR\x03sig\":\n" +
	"\x1fEvmGetPubkeyFromSignatureResult\x12\x17\n" +
	"\apub_key\x18\x01 \x01(\fR\x06pubKey\"/\n" +
	"\x13IsAddressEoaRequest\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\"+\n" +
	"\x12IsAddressEoaResult\x12\x15\n" +
	"\x06is_eoa\x18\x01 \x01(\bR\x05isEoa\"'\n" +
	"\x11HashBlake3Request\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\"&\n" +
	"\x10HashBlake3Result\x12\x12\n" +
	"\x04hash\x18\x01 \x01(\fR\x04hash\"s\n" +
	"\x10GetDsKeysRequest\x12\x16\n" +
	"\x06prefix\x18\x01 \x01(\fR\x06prefix\x12;\n" +
	"\aaddress\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueH\x00R\aaddress\x88\x01\x01B\n" +
	"\n" +
	"\b_address\"%\n" +
	"\x0fGetDsKeysResult\x12\x12\n" +
	"\x04keys\x18\x01 \x03(\fR\x04keys\"\x84\x01\n" +
	"\x11SetDsValueRequest\x12\x10\n" +
	"\x03key\x18\x01 \x01(\fR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value\x12;\n" +
	"\aaddress\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueH\x00R\aaddress\x88\x01\x01B\n" +
	"\n" +
	"\b_address\"\x12\n" +
	"\x10SetDsValueResult\"\x87\x01\n" +
	"\x14AppendDsValueRequest\x12\x10\n" +
	"\x03key\x18\x01 \x01(\fR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value\x12;\n" +
	"\aaddress\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueH\x00R\aaddress\x88\x01\x01B\n" +
	"\n" +
	"\b_address\"\x15\n" +
	"\x13AppendDsValueResult\"n\n" +
	"\x11GetDsValueRequest\x12\x10\n" +
	"\x03key\x18\x01 \x01(\fR\x03key\x12;\n" +
	"\aaddress\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueH\x00R\aaddress\x88\x01\x01B\n" +
	"\n" +
	"\b_address\"(\n" +
	"\x10GetDsValueResult\x12\x14\n" +
	"\x05value\x18\x01 \x01(\fR\x05value\"q\n" +
	"\x14DeleteDsEntryRequest\x12\x10\n" +
	"\x03key\x18\x01 \x01(\fR\x03key\x12;\n" +
	"\aaddress\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueH\x00R\aaddress\x88\x01\x01B\n" +
	"\n" +
	"\b_address\"\x15\n" +
	"\x13DeleteDsEntryResult\"q\n" +
	"\x14DsEntryExistsRequest\x12\x10\n" +
	"\x03key\x18\x01 \x01(\fR\x03key\x12;\n" +
	"\aaddress\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueH\x00R\aaddress\x88\x01\x01B\n" +
	"\n" +
	"\b_address\"0\n" +
	"\x13DsEntryExistsResult\x12\x19\n" +
	"\bhas_data\x18\x01 \x01(\bR\ahasData\"\x1a\n" +
	"\x18GetOwnedAddressesRequest\"7\n" +
	"\x17GetOwnedAddressesResult\x12\x1c\n" +
	"\taddresses\x18\x01 \x03(\tR\taddresses\"\x15\n" +
	"\x13GetCallStackRequest\"*\n" +
	"\x12GetCallStackResult\x12\x14\n" +
	"\x05calls\x18\x01 \x03(\tR\x05calls\"3\n" +
	"\x18AddressFromPubKeyRequest\x12\x17\n" +
	"\apub_key\x18\x01 \x01(\tR\x06pubKey\"3\n" +
	"\x17AddressFromPubKeyResult\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\"2\n" +
	"\x13UnsafeRandomRequest\x12\x1b\n" +
	"\tnum_bytes\x18\x02 \x01(\rR\bnumBytes\"7\n" +
	"\x12UnsafeRandomResult\x12!\n" +
	"\frandom_bytes\x18\x01 \x01(\fR\vrandomBytes\"R\n" +
	"\x19DeferredCallCancelRequest\x125\n" +
	"\acall_id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x06callId\"\x1a\n" +
	"\x18DeferredCallCancelResult\"\x8b\x01\n" +
	"\x18DeferredCallQuoteRequest\x125\n" +
	...
	"paramsSize\"K\n" +
	"\x17DeferredCallQuoteResult\x12\x1c\n" +
	"\tavailable\x18\x01 \x01(\bR\tavailable\x12\x12\n" +
	"\x04cost\x18\x02 \x01(\x04R\x04cost\"R\n" +
	"\x19DeferredCallExistsRequest\x125\n" +
	"\acall_id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x06callId\";\n" +
	"\x18DeferredCallExistsResult\x12\x1f\n" +
	"\vcall_exists\x18\x01 \x01(\bR\n" +
	"callExists\"\xeb\x01\n" +
	"\x1bDeferredCallRegisterRequest\x12%\n" +
	"\x0etarget_address\x18\x01 \x01(\tR\rtargetAddress\x12'\n" +
	"\x0ftarget_function\x18\x02 \x01(\tR\x0etargetFunction\x125\n" +
	"\vtarget_slot\x18\x03 \x01(\v2\x14.massa.model.v1.SlotR\n" +
	"targetSlot\x12\x17\n" +
	"\amax_gas\x18\x04 \x01(\x04R\x06maxGas\x12\x16\n" +
	"\x06params\x18\x05 \x01(\fR\x06params\x12\x14\n" +
	"\x05coins\x18\x06 \x01(\x04R\x05coins\"S\n" +
	"\x1aDeferredCallRegisterResult\x125\n" +
	"\acall_id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x06callId\"{\n" +
	"\x16SendAsyncMessageFilter\x12%\n" +
	"\x0etarget_address\x18\x01 \x01(\tR\rtargetAddress\x12:\n" +
	"\n" +
	"target_key\x18\x02 \x01(\v2\x1b.google.protobuf.BytesValueR\ttargetKey\"\x8a\x03\n" +
	"\x17SendAsyncMessageRequest\x12%\n" +
	"\x0etarget_address\x18\x01 \x01(\tR\rtargetAddress\x12%\n" +
	"\x0etarget_handler\x18\x02 \x01(\tR\rtargetHandler\x12;\n" +
	"\x0evalidity_start\x18\x03 \x01(\v2\x14.massa.model.v1.SlotR\rvalidityStart\x127\n" +
	"\fvalidity_end\x18\x04 \x01(\v2\x14.massa.model.v1.SlotR\vvalidityEnd\x12#\n" +
	"\rexecution_gas\x18\x05 \x01(\x04R\fexecutionGas\x12\x17\n" +
	"\araw_fee\x18\x06 \x01(\x04R\x06rawFee\x12\x1b\n" +
	"\traw_coins\x18\a \x01(\x04R\brawCoins\x12\x12\n" +
	"\x04data\x18\b \x01(\fR\x04data\x12<\n" +
	"\x06filter\x18\t \x01(\v2$.massa.abi.v1.SendAsyncMessageFilterR\x06filter\"\x18\n" +
	"\x16SendAsyncMessageResult\"\x1d\n" +
	"\x1bGetOriginOperationIdRequest\"s\n" +
	"\x1aGetOriginOperationIdResult\x12D\n" +
	"\foperation_id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueH\x00R\voperationId\x88\x01\x01B\x0f\n" +
	"\r_operation_id\"\x16\n" +
	"\x14GetNativeTimeRequest\"E\n" +
	"\x13GetNativeTimeResult\x12.\n" +
	"\x04time\x18\x01 \x01(\v2\x1a.massa.model.v1.NativeTimeR\x04time\"\x17\n" +
	"\x15GetCurrentSlotRequest\"@\n" +
	"\x14GetCurrentSlotResult\x12(\n" +
	"\x04slot\x18\x01 \x01(\v2\x14.massa.model.v1.SlotR\x04slot\"y\n" +
	"\x12SetBytecodeRequest\x12\x1a\n" +
	"\bbytecode\x18\x01 \x01(\fR\bbytecode\x12;\n" +
	"\aaddress\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueH\x00R\aaddress\x88\x01\x01B\n" +
	"\n" +
	"\b_address\"\x13\n" +
	"\x11SetBytecodeResult\"]\n" +
	"\x12GetBytecodeRequest\x12;\n" +
	"\aaddress\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueH\x00R\aaddress\x88\x01\x01B\n" +
	"\n" +
	"\b_address\"/\n" +
	"\x11GetBytecodeResult\x12\x1a\n" +
	"\bbytecode\x18\x01 \x01(\fR\bbytecode\"\x1d\n" +
	"\x1bCallerHasWriteAccessRequest\"F\n" +
	"\x1aCallerHasWriteAccessResult\x12(\n" +
	"\x10has_write_access\x18\x01 \x01(\bR\x0ehasWriteAccess\"'\n" +
	"\x11HashSha256Request\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\"&\n" +
	"\x10HashSha256Result\x12\x12\n" +
	"\x04hash\x18\x01 \x01(\fR\x04hash\"$\n" +
	"\x10GetOpDataRequest\x12\x10\n" +
	"\x03key\x18\x01 \x01(\fR\x03key\"'\n" +
	"\x0fGetOpDataResult\x12\x14\n" +
	"\x05value\x18\x01 \x01(\fR\x05value\"(\n" +
	"\x14OpEntryExistsRequest\x12\x10\n" +
	"\x03key\x18\x01 \x01(\fR\x03key\".\n" +
	"\x13OpEntryExistsResult\x12\x17\n" +
	"\ahas_key\x18\x01 \x01(\bR\x06hasKey\"*\n" +
	"\x10GetOpKeysRequest\x12\x16\n" +
	"\x06prefix\x18\x01 \x01(\fR\x06prefix\"%\n" +
	"\x0fGetOpKeysResult\x12\x12\n" +
	"\x04keys\x18\x01 \x03(\fR\x04keys\"\x18\n" +
	"\x16GetRemainingGasRequest\"<\n" +
	"\x15GetRemainingGasResult\x12#\n" +
	"\rremaining_gas\x18\x01 \x01(\x04R\fremainingGas\"\\\n" +
	"\x11GetBalanceRequest\x12;\n" +
	"\aaddress\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueH\x00R\aaddress\x88\x01\x01B\n" +
	"\n" +
	"\b_address\"J\n" +
	"\x10GetBalanceResult\x126\n" +
	"\abalance\x18\x01 \x01(\v2\x1c.massa.model.v1.NativeAmountR\abalance\"\x15\n" +
	"\x13GetCallCoinsRequest\"H\n" +
	"\x12GetCallCoinsResult\x122\n" +
	"\x05coins\x18\x01 \x01(\v2\x1c.massa.model.v1.NativeAmountR\x05coins\"4\n" +
	"\x18GetAddressVersionRequest\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\"3\n" +
	"\x17GetAddressVersionResult\x12\x18\n" +
	"\aversion\x18\x01 \x01(\x04R\aversion\"5\n" +
	"\x19GetAddressCategoryRequest\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\"W\n" +
	"\x18GetAddressCategoryResult\x12;\n" +
	"\bcategory\x18\x01 \x01(\x0e2\x1f.massa.model.v1.AddressCategoryR\bcategory\"2\n" +
	"\x17GetPubKeyVersionRequest\x12\x17\n" +
	"\apub_key\x18\x01 \x01(\tR\x06pubKey\"2\n" +
	"\x16GetPubKeyVersionResult\x12\x18\n" +
	"\aversion\x18\x01 \x01(\x04R\aversion\":\n" +
	"\x1aGetSignatureVersionRequest\x12\x1c\n" +
	"\tsignature\x18\x01 \x01(\tR\tsignature\"5\n" +
	"\x19GetSignatureVersionResult\x12\x18\n" +
	"\aversion\x18\x01 \x01(\x04R\aversion\"1\n" +
	"\x19BytesToBase58CheckRequest\x12\x14\n" +
	"\x05bytes\x18\x01 \x01(\fR\x05bytes\"=\n" +
	"\x18BytesToBase58CheckResult\x12!\n" +
	"\fbase58_check\x18\x01 \x01(\tR\vbase58Check\">\n" +
	"\x19Base58CheckToBytesRequest\x12!\n" +
	"\fbase58_check\x18\x01 \x01(\tR\vbase58Check\"0\n" +
	"\x18Base58CheckToBytesResult\x12\x14\n" +
...
var (
	...
	file_massa_abi_v1_abi_proto_rawDescData []byte
)

func file_massa_abi_v1_abi_proto_rawDescGZIP() []byte {
	file_massa_abi_v1_abi_proto_rawDescOnce.Do(func() {
		file_massa_abi_v1_abi_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_massa_abi_v1_abi_proto_rawDesc), len(file_massa_abi_v1_abi_proto_rawDesc)))
	})
	return file_massa_abi_v1_abi_proto_rawDescData
}

var file_massa_abi_v1_abi_proto_msgTypes = make([]protoimpl.MessageInfo, 140)
var file_massa_abi_v1_abi_proto_goTypes = []any{
	...
	(*DeferredCallCancelRequest)(nil),            // 89: massa.abi.v1.DeferredCallCancelRequest
	(*DeferredCallCancelResult)(nil),             // 90: massa.abi.v1.DeferredCallCancelResult
	(*DeferredCallQuoteRequest)(nil),             // 91: massa.abi.v1.DeferredCallQuoteRequest
	(*DeferredCallQuoteResult)(nil),              // 92: massa.abi.v1.DeferredCallQuoteResult
	(*DeferredCallExistsRequest)(nil),            // 93: massa.abi.v1.DeferredCallExistsRequest
	(*DeferredCallExistsResult)(nil),             // 94: massa.abi.v1.DeferredCallExistsResult
	(*DeferredCallRegisterRequest)(nil),          // 95: massa.abi.v1.DeferredCallRegisterRequest
	(*DeferredCallRegisterResult)(nil),           // 96: massa.abi.v1.DeferredCallRegisterResult
	(*SendAsyncMessageFilter)(nil),               // 97: massa.abi.v1.SendAsyncMessageFilter
	(*SendAsyncMessageRequest)(nil),              // 98: massa.abi.v1.SendAsyncMessageRequest
	(*SendAsyncMessageResult)(nil),               // 99: massa.abi.v1.SendAsyncMessageResult
	(*GetOriginOperationIdRequest)(nil),          // 100: massa.abi.v1.GetOriginOperationIdRequest
	(*GetOriginOperationIdResult)(nil),           // 101: massa.abi.v1.GetOriginOperationIdResult
	(*GetNativeTimeRequest)(nil),                 // 102: massa.abi.v1.GetNativeTimeRequest
	(*GetNativeTimeResult)(nil),                  // 103: massa.abi.v1.GetNativeTimeResult
	(*GetCurrentSlotRequest)(nil),                // 104: massa.abi.v1.GetCurrentSlotRequest
	(*GetCurrentSlotResult)(nil),                 // 105: massa.abi.v1.GetCurrentSlotResult
	(*SetBytecodeRequest)(nil),                   // 106: massa.abi.v1.SetBytecodeRequest
	(*SetBytecodeResult)(nil),                    // 107: massa.abi.v1.SetBytecodeResult
	(*GetBytecodeRequest)(nil),                   // 108: massa.abi.v1.GetBytecodeRequest
	(*GetBytecodeResult)(nil),                    // 109: massa.abi.v1.GetBytecodeResult
	(*CallerHasWriteAccessRequest)(nil),          // 110: massa.abi.v1.CallerHasWriteAccessRequest
	(*CallerHasWriteAccessResult)(nil),           // 111: massa.abi.v1.CallerHasWriteAccessResult
	(*HashSha256Request)(nil),                    // 112: massa.abi.v1.HashSha256Request
	(*HashSha256Result)(nil),                     // 113: massa.abi.v1.HashSha256Result
	(*GetOpDataRequest)(nil),                     // 114: massa.abi.v1.GetOpDataRequest
	(*GetOpDataResult)(nil),                      // 115: massa.abi.v1.GetOpDataResult
	(*OpEntryExistsRequest)(nil),                 // 116: massa.abi.v1.OpEntryExistsRequest
	(*OpEntryExistsResult)(nil),                  // 117: massa.abi.v1.OpEntryExistsResult
	(*GetOpKeysRequest)(nil),                     // 118: massa.abi.v1.GetOpKeysRequest
	(*GetOpKeysResult)(nil),                      // 119: massa.abi.v1.GetOpKeysResult
	(*GetRemainingGasRequest)(nil),               // 120: massa.abi.v1.GetRemainingGasRequest
	(*GetRemainingGasResult)(nil),                // 121: massa.abi.v1.GetRemainingGasResult
	(*GetBalanceRequest)(nil),                    // 122: massa.abi.v1.GetBalanceRequest
	(*GetBalanceResult)(nil),                     // 123: massa.abi.v1.GetBalanceResult
	(*GetCallCoinsRequest)(nil),                  // 124: massa.abi.v1.GetCallCoinsRequest
	(*GetCallCoinsResult)(nil),                   // 125: massa.abi.v1.GetCallCoinsResult
	(*GetAddressVersionRequest)(nil),             // 126: massa.abi.v1.GetAddressVersionRequest
	(*GetAddressVersionResult)(nil),              // 127: massa.abi.v1.GetAddressVersionResult
	(*GetAddressCategoryRequest)(nil),            // 128: massa.abi.v1.GetAddressCategoryRequest
	(*GetAddressCategoryResult)(nil),             // 129: massa.abi.v1.GetAddressCategoryResult
	(*GetPubKeyVersionRequest)(nil),              // 130: massa.abi.v1.GetPubKeyVersionRequest
	(*GetPubKeyVersionResult)(nil),               // 131: massa.abi.v1.GetPubKeyVersionResult
	(*GetSignatureVersionRequest)(nil),           // 132: massa.abi.v1.GetSignatureVersionRequest
	(*GetSignatureVersionResult)(nil),            // 133: massa.abi.v1.GetSignatureVersionResult
	(*BytesToBase58CheckRequest)(nil),            // 134: massa.abi.v1.BytesToBase58CheckRequest
	(*BytesToBase58CheckResult)(nil),             // 135: massa.abi.v1.BytesToBase58CheckResult
	(*Base58CheckToBytesRequest)(nil),            // 136: massa.abi.v1.Base58CheckToBytesRequest
	(*Base58CheckToBytesResult)(nil),             // 137: massa.abi.v1.Base58CheckToBytesResult
	(*ChainIdRequest)(nil),                       // 138: massa.abi.v1.ChainIdRequest
	(*ChainIdResult)(nil),                        // 139: massa.abi.v1.ChainIdResult
	(*v1.NativeAmount)(nil),                      // 140: massa.model.v1.NativeAmount
	(*wrapperspb.StringValue)(nil),               // 141: google.protobuf.StringValue
	(*v1.NativeTime)(nil),                        // 142: massa.model.v1.NativeTime
	(v1.ComparisonResult)(0),                     // 143: massa.model.v1.ComparisonResult
	(*v1.Slot)(nil),                              // 144: massa.model.v1.Slot
	(*wrapperspb.BytesValue)(nil),                // 145: google.protobuf.BytesValue
	(v1.AddressCategory)(0),                      // 146: massa.model.v1.AddressCategory
}
var file_massa_abi_v1_abi_proto_depIdxs = []int32{
	140, // 0: massa.abi.v1.CallRequest.call_coins:type_name -> massa.model.v1.NativeAmount
	140, // 1: massa.abi.v1.TransferCoinsRequest.amount_to_transfer:type_name -> massa.model.v1.NativeAmount
	141, // 2: massa.abi.v1.TransferCoinsRequest.sender_address:type_name -> google.protobuf.StringValue
	...
	137, // 6: massa.abi.v1.RespResult.base58_check_to_bytes_result:type_name -> massa.abi.v1.Base58CheckToBytesResult
	135, // 7: massa.abi.v1.RespResult.bytes_to_base58_check_result:type_name -> massa.abi.v1.BytesToBase58CheckResult
	111, // 8: massa.abi.v1.RespResult.caller_has_write_access_result:type_name -> massa.abi.v1.CallerHasWriteAccessResult
	...
	129, // 28: massa.abi.v1.RespResult.get_address_category_result:type_name -> massa.abi.v1.GetAddressCategoryResult
	127, // 29: massa.abi.v1.RespResult.get_address_version_result:type_name -> massa.abi.v1.GetAddressVersionResult
	123, // 30: massa.abi.v1.RespResult.get_balance_result:type_name -> massa.abi.v1.GetBalanceResult
	109, // 31: massa.abi.v1.RespResult.get_bytecode_result:type_name -> massa.abi.v1.GetBytecodeResult
	125, // 32: massa.abi.v1.RespResult.get_call_coins_result:type_name -> massa.abi.v1.GetCallCoinsResult
	84,  // 33: massa.abi.v1.RespResult.get_call_stack_result:type_name -> massa.abi.v1.GetCallStackResult
	105, // 34: massa.abi.v1.RespResult.get_current_slot_result:type_name -> massa.abi.v1.GetCurrentSlotResult
	...
	103, // 37: massa.abi.v1.RespResult.get_native_time_result:type_name -> massa.abi.v1.GetNativeTimeResult
	115, // 38: massa.abi.v1.RespResult.get_op_data_result:type_name -> massa.abi.v1.GetOpDataResult
	119, // 39: massa.abi.v1.RespResult.get_op_keys_result:type_name -> massa.abi.v1.GetOpKeysResult
	101, // 40: massa.abi.v1.RespResult.get_origin_operation_id_result:type_name -> massa.abi.v1.GetOriginOperationIdResult
	82,  // 41: massa.abi.v1.RespResult.get_owned_addresses_result:type_name -> massa.abi.v1.GetOwnedAddressesResult
	131, // 42: massa.abi.v1.RespResult.get_pub_key_version_result:type_name -> massa.abi.v1.GetPubKeyVersionResult
	121, // 43: massa.abi.v1.RespResult.get_remaining_gas_result:type_name -> massa.abi.v1.GetRemainingGasResult
	133, // 44: massa.abi.v1.RespResult.get_signature_version_result:type_name -> massa.abi.v1.GetSignatureVersionResult
	68,  // 45: massa.abi.v1.RespResult.hash_blake3_result:type_name -> massa.abi.v1.HashBlake3Result
	113, // 46: massa.abi.v1.RespResult.hash_sha256_result:type_name -> massa.abi.v1.HashSha256Result
	117, // 47: massa.abi.v1.RespResult.op_entry_exists_result:type_name -> massa.abi.v1.OpEntryExistsResult
	...
	99,  // 54: massa.abi.v1.RespResult.send_async_message_result:type_name -> massa.abi.v1.SendAsyncMessageResult
	107, // 55: massa.abi.v1.RespResult.set_bytecode_result:type_name -> massa.abi.v1.SetBytecodeResult
	...
	139, // 65: massa.abi.v1.RespResult.chain_id_result:type_name -> massa.abi.v1.ChainIdResult
	92,  // 66: massa.abi.v1.RespResult.deferred_call_quote_result:type_name -> massa.abi.v1.DeferredCallQuoteResult
	94,  // 67: massa.abi.v1.RespResult.deferred_call_exists_result:type_name -> massa.abi.v1.DeferredCallExistsResult
	96,  // 68: massa.abi.v1.RespResult.deferred_call_register_result:type_name -> massa.abi.v1.DeferredCallRegisterResult
	90,  // 69: massa.abi.v1.RespResult.deferred_call_cancel_result:type_name -> massa.abi.v1.DeferredCallCancelResult
	13,  // 70: massa.abi.v1.AbiResponse.res:type_name -> massa.abi.v1.RespResult
	0,   // 71: massa.abi.v1.AbiResponse.error:type_name -> massa.abi.v1.Error
	140, // 72: massa.abi.v1.NativeAmountToStringRequest.to_convert:type_name -> massa.model.v1.NativeAmount
	140, // 73: massa.abi.v1.NativeAmountFromStringResult.converted_amount:type_name -> massa.model.v1.NativeAmount
	140, // 74: massa.abi.v1.CheckNativeAmountRequest.to_check:type_name -> massa.model.v1.NativeAmount
	140, // 75: massa.abi.v1.AddNativeAmountRequest.amount1:type_name -> massa.model.v1.NativeAmount
	140, // 76: massa.abi.v1.AddNativeAmountRequest.amount2:type_name -> massa.model.v1.NativeAmount
	140, // 77: massa.abi.v1.AddNativeAmountResult.sum:type_name -> massa.model.v1.NativeAmount
	140, // 78: massa.abi.v1.SubNativeAmountRequest.left:type_name -> massa.model.v1.NativeAmount
	140, // 79: massa.abi.v1.SubNativeAmountRequest.right:type_name -> massa.model.v1.NativeAmount
	140, // 80: massa.abi.v1.SubNativeAmountResult.difference:type_name -> massa.model.v1.NativeAmount
	140, // 81: massa.abi.v1.ScalarMulNativeAmountRequest.amount:type_name -> massa.model.v1.NativeAmount
	140, // 82: massa.abi.v1.ScalarMulNativeAmountResult.product:type_name -> massa.model.v1.NativeAmount
	140, // 83: massa.abi.v1.ScalarDivRemNativeAmountRequest.dividend:type_name -> massa.model.v1.NativeAmount
	140, // 84: massa.abi.v1.ScalarDivRemNativeAmountResult.quotient:type_name -> massa.model.v1.NativeAmount
	140, // 85: massa.abi.v1.ScalarDivRemNativeAmountResult.remainder:type_name -> massa.model.v1.NativeAmount
	140, // 86: massa.abi.v1.DivRemNativeAmountRequest.dividend:type_name -> massa.model.v1.NativeAmount
	140, // 87: massa.abi.v1.DivRemNativeAmountRequest.divisor:type_name -> massa.model.v1.NativeAmount
	140, // 88: massa.abi.v1.DivRemNativeAmountResult.remainder:type_name -> massa.model.v1.NativeAmount
	142, // 89: massa.abi.v1.CheckedAddNativeTimeRequest.left:type_name -> massa.model.v1.NativeTime
	142, // 90: massa.abi.v1.CheckedAddNativeTimeRequest.right:type_name -> massa.model.v1.NativeTime
	142, // 91: massa.abi.v1.CheckedAddNativeTimeResult.sum:type_name -> massa.model.v1.NativeTime
	142, // 92: massa.abi.v1.CheckedSubNativeTimeRequest.left:type_name -> massa.model.v1.NativeTime
	142, // 93: massa.abi.v1.CheckedSubNativeTimeRequest.right:type_name -> massa.model.v1.NativeTime
	142, // 94: massa.abi.v1.CheckedSubNativeTimeResult.difference:type_name -> massa.model.v1.NativeTime
	142, // 95: massa.abi.v1.CheckedScalarMulNativeTimeRequest.time:type_name -> massa.model.v1.NativeTime
	142, // 96: massa.abi.v1.CheckedScalarMulNativeTimeResult.product:type_name -> massa.model.v1.NativeTime
	142, // 97: massa.abi.v1.CheckedScalarDivRemNativeTimeRequest.dividend:type_name -> massa.model.v1.NativeTime
	142, // 98: massa.abi.v1.CheckedScalarDivRemNativeTimeResult.quotient:type_name -> massa.model.v1.NativeTime
	142, // 99: massa.abi.v1.CheckedScalarDivRemNativeTimeResult.remainder:type_name -> massa.model.v1.NativeTime
	142, // 100: massa.abi.v1.CheckedDivRemNativeTimeRequest.dividend:type_name -> massa.model.v1.NativeTime
	142, // 101: massa.abi.v1.CheckedDivRemNativeTimeRequest.divisor:type_name -> massa.model.v1.NativeTime
	142, // 102: massa.abi.v1.CheckedDivRemNativeTimeResult.remainder:type_name -> massa.model.v1.NativeTime
	142, // 103: massa.abi.v1.CompareNativeTimeRequest.left:type_name -> massa.model.v1.NativeTime
	142, // 104: massa.abi.v1.CompareNativeTimeRequest.right:type_name -> massa.model.v1.NativeTime
	143, // 105: massa.abi.v1.CompareNativeTimeResult.result:type_name -> massa.model.v1.ComparisonResult
	143, // 106: massa.abi.v1.CompareAddressResult.result:type_name -> massa.model.v1.ComparisonResult
	143, // 107: massa.abi.v1.ComparePubKeyResult.result:type_name -> massa.model.v1.ComparisonResult
	140, // 108: massa.abi.v1.CompareNativeAmountRequest.left:type_name -> massa.model.v1.NativeAmount
	140, // 109: massa.abi.v1.CompareNativeAmountRequest.right:type_name -> massa.model.v1.NativeAmount
	143, // 110: massa.abi.v1.CompareNativeAmountResult.result:type_name -> massa.model.v1.ComparisonResult
	141, // 111: massa.abi.v1.GetDsKeysRequest.address:type_name -> google.protobuf.StringValue
	141, // 112: massa.abi.v1.SetDsValueRequest.address:type_name -> google.protobuf.StringValue
	141, // 113: massa.abi.v1.AppendDsValueRequest.address:type_name -> google.protobuf.StringValue
	141, // 114: massa.abi.v1.GetDsValueRequest.address:type_name -> google.protobuf.StringValue
	141, // 115: massa.abi.v1.DeleteDsEntryRequest.address:type_name -> google.protobuf.StringValue
	141, // 116: massa.abi.v1.DsEntryExistsRequest.address:type_name -> google.protobuf.StringValue
	141, // 117: massa.abi.v1.DeferredCallCancelRequest.call_id:type_name -> google.protobuf.StringValue
	144, // 118: massa.abi.v1.DeferredCallQuoteRequest.target_slot:type_name -> massa.model.v1.Slot
	141, // 119: massa.abi.v1.DeferredCallExistsRequest.call_id:type_name -> google.protobuf.StringValue
	144, // 120: massa.abi.v1.DeferredCallRegisterRequest.target_slot:type_name -> massa.model.v1.Slot
	141, // 121: massa.abi.v1.DeferredCallRegisterResult.call_id:type_name -> google.protobuf.StringValue
	145, // 122: massa.abi.v1.SendAsyncMessageFilter.target_key:type_name -> google.protobuf.BytesValue
	144, // 123: massa.abi.v1.SendAsyncMessageRequest.validity_start:type_name -> massa.model.v1.Slot
	144, // 124: massa.abi.v1.SendAsyncMessageRequest.validity_end:type_name -> massa.model.v1.Slot
	97,  // 125: massa.abi.v1.SendAsyncMessageRequest.filter:type_name -> massa.abi.v1.SendAsyncMessageFilter
	141, // 126: massa.abi.v1.GetOriginOperationIdResult.operation_id:type_name -> google.protobuf.StringValue
	142, // 127: massa.abi.v1.GetNativeTimeResult.time:type_name -> massa.model.v1.NativeTime
	144, // 128: massa.abi.v1.GetCurrentSlotResult.slot:type_name -> massa.model.v1.Slot
	141, // 129: massa.abi.v1.SetBytecodeRequest.address:type_name -> google.protobuf.StringValue
	141, // 130: massa.abi.v1.GetBytecodeRequest.address:type_name -> google.protobuf.StringValue
	141, // 131: massa.abi.v1.GetBalanceRequest.address:type_name -> google.protobuf.StringValue
	140, // 132: massa.abi.v1.GetBalanceResult.balance:type_name -> massa.model.v1.NativeAmount
	140, // 133: massa.abi.v1.GetCallCoinsResult.coins:type_name -> massa.model.v1.NativeAmount
	146, // 134: massa.abi.v1.GetAddressCategoryResult.category:type_name -> massa.model.v1.AddressCategory
...
func file_massa_abi_v1_abi_proto_init() {
	...
	file_massa_abi_v1_abi_proto_msgTypes[9].OneofWrappers = []any{}
	file_massa_abi_v1_abi_proto_msgTypes[13].OneofWrappers = []any{
		...
		(*RespResult_DeferredCallQuoteResult)(nil),
		(*RespResult_DeferredCallExistsResult)(nil),
		(*RespResult_DeferredCallRegisterResult)(nil),
		(*RespResult_DeferredCallCancelResult)(nil),
	}
	file_massa_abi_v1_abi_proto_msgTypes[14].OneofWrappers = []any{
		(*AbiResponse_Res)(nil),
		(*AbiResponse_Error)(nil),
	}
	file_massa_abi_v1_abi_proto_msgTypes[69].OneofWrappers = []any{}
	file_massa_abi_v1_abi_proto_msgTypes[71].OneofWrappers = []any{}
	file_massa_abi_v1_abi_proto_msgTypes[73].OneofWrappers = []any{}
	file_massa_abi_v1_abi_proto_msgTypes[75].OneofWrappers = []any{}
	file_massa_abi_v1_abi_proto_msgTypes[77].OneofWrappers = []any{}
	file_massa_abi_v1_abi_proto_msgTypes[79].OneofWrappers = []any{}
	file_massa_abi_v1_abi_proto_msgTypes[101].OneofWrappers = []any{}
	file_massa_abi_v1_abi_proto_msgTypes[106].OneofWrappers = []any{}
	file_massa_abi_v1_abi_proto_msgTypes[108].OneofWrappers = []any{}
	file_massa_abi_v1_abi_proto_msgTypes[122].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_massa_abi_v1_abi_proto_rawDesc), len(file_massa_abi_v1_abi_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   140,
			NumExtensions: 0,
			NumServices:   0,
